...
function Account() {
  return (
    ...
    >
      ...
      <section className="mt-12 grid gap-6 rounded-2xl bg-primary p-6 text-primary-foreground shadow-[0_20px_50px_-20px_rgba(23,22,19,0.4)] md:grid-cols-[180px_1fr_auto] md:items-center md:p-8">
        <img
          src={ananya.src}
          alt="Ananya Kulkarni"
          width={912}
