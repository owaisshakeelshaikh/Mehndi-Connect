        ...
        <section className="relative min-h-[80vh] bg-primary text-primary-foreground">
          ...
          <div className="relative mx-auto flex min-h-[80vh] max-w-[1440px] flex-col justify-end px-5 pb-16 md:px-8">
            ...
            <h1 className="max-w-4xl text-7xl leading-[0.9] md:text-9xl">
              The hands shaping a <em className="text-saffron">modern tradition.</em>
            </h1>
            <Link
              href="/about"
              className="group mt-8 flex items-center gap-2 text-[10px] font-bold uppercase tracking-[0.2em] text-saffron"
            >
              ...
              {stories.map((story, i) => (
                ...
                >
                  <article className="group">
                    <div className="overflow-hidden rounded-2xl shadow-[0_16px_44px_-18px_rgba(23,22,19,0.3)]">
                      <img
